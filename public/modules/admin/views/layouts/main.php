                ...
                <div class="user-info">
                    ...
                    <div class="user-image">
                        <a href="extra-profile.html">
                            <img src="<?=$bundle->baseUrl?>/images/user-2.png" class="img-responsive img-circle" />
                        </a>
                    </div>
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="sidebar-menu toggle-others fixed">
        ...
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <?php foreach ($menu as $k1=>$item1){?>
                    <li<?=StringHelper::startsWith($currUrl,$k1)?' class="active opened active"':''?>>
                        <a href="<?=Yii::$app->urlManager->createUrl(array_merge([$k1],$item1['urlParams']))?>">
                            <?php if($item1['class']){?><i class="<?=$item1['class']?>"></i><?php }else{?> <?php }?>
                            <span class="title"><?=$item1['label']?></span>
                        </a>
                        <? if($item1['items']){?>
                        <ul>
                            <? foreach($item1['items'] as $k2=>$item2){?>
                            <li<?=StringHelper::startsWith($currUrl,$k2)?' class="active"':''?>>
                                <a href="<?=Yii::$app->urlManager->createUrl(array_merge([$k2],$item2['urlParams']))?>">
                                    <span class="title"><?=$item2['label']?></span>
                                </a>
                            </li>
                            <? }?>
                        </ul>
    ...
    <div class="main-content">
        ...
        <nav class="navbar user-info-navbar" role="navigation" style="display: None;">
            ...
            <ul class="user-info-menu right-links list-inline list-unstyled">
                ...
                <li class="dropdown user-profile">
                    <a href="#" data-toggle="dropdown">
                        <img src="<?=$bundle->baseUrl?>/images/user-4.png" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
							<span>
